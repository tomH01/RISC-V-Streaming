...
$sim_config setDesignTopModulePath "memory_simple"
$sim_config setSimulationTopModulePath "memory_simple"

# Set timescale
$sim_config setDefaultTimescale "1ps/1ps"

# Components
$sim_config addComponent [EDA::Design::getComponent "memory_simple"] top
...
$sim_config addWaveformScope "memory_simple"
