...
# Memory macros
set macro_timing_conditions [list \
  tt0p8v25c_0p8v_0v_0v \
  ssg_fcmax0p72v125c_0p72v_0v_0v \
  ssg_fcmax0p72vn40c_0p72v_0v_0v \
  ffg_fcmin0p88v125c_0p88v_0v_0v \
  ffg_fcmin0p88vn40c_0p88v_0v_0v \
]

set sram_names [list \
  "sadclssd4LOW1p128x32m16b1w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p256x32m16b1w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p512x32m16b2w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p1024x32m16b2w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p2048x32m16b2w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p4096x32m16b2w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p8192x32m16b2w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p16384x32m16b4w1c0p1d0l0rm3sdrw01" \
  "sadclssd4LOW1p32768x32m16b8w1c0p1d0l0rm3sdrw01" \
]

foreach sram $sram_names {
  set macro [$technology getMacro "synopsys" $sram]
  $macro addTimingConditions $macro_timing_conditions
}
